      ...
      {answers.map((answer, index) => {
        ...
        return (
          <div
            ...
            className={`grid grid-cols-[auto_1fr_auto] items-center gap-1.5 md:gap-3 px-3 md:px-4 py-2.5 md:py-3 rounded-xl transition-all duration-200 border ${
              isCorrect
          ...
          >
            {/* Rank badge */}
            <div className={`flex items-center justify-center w-6 h-6 md:w-9 md:h-9 rounded-full font-bold text-[13px] md:text-sm flex-shrink-0 ${
              isCorrect
            ...
            <div className="flex items-center gap-1 md:gap-2 min-h-[24px] md:min-h-[32px]">
              {isRevealed ? (
                <>
                  {isCorrect && (
                ...
                <span className="text-[14px] md:text-sm text-gold font-medium italic animate-fade-in">
                  {currentHint}
                </span>
              ) : (
                <div className="flex items-center gap-1 md:gap-2">
                  <Lock className="h-3 w-3 md:h-4 md:w-4 text-muted-foreground/70" />
                  <span className="text-[14px] md:text-base text-muted-foreground">Locked</span>
                </div>
              )}
            </div>
