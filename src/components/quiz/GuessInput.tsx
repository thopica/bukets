...
const GuessInput = ({ onGuess, onRequestHint, onShuffle, disabled = false, hintsRemaining = 0, currentHint, showError = false, showSuccess = false, hintsUsed = 0 }: GuessInputProps) => {
  ...
  return (
    <div className="bg-background p-1 md:p-3 md:border-t md:border-t-2 border-border md:sticky md:bottom-0 md:shadow-floating z-[1000]" style={{ paddingBottom: `max(0.25rem, env(safe-area-inset-bottom))` }}>
