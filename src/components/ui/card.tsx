...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("rounded-2xl border-2 border-border bg-card text-card-foreground shadow-[0_2px_8px_rgba(0,0,0,0.12)] transition-shadow duration-200 hover:shadow-[0_4px_16px_rgba(0,0,0,0.16)]", className)} {...props} />
));
